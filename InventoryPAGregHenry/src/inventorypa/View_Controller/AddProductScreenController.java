...
public class AddProductScreenController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Inventory.uniqueProductID += 1;
        productID.setText(Integer.toString(Inventory.uniqueProductID));
    ...
    private void addPart(ActionEvent event) {
        ...
        tempParts.add(DeleteTable.getSelectionModel().getSelectedItem()); 
    ...
    private void save(ActionEvent event) throws IOException {
        if(Integer.parseInt(min.getText()) >= Integer.parseInt(max.getText())) {
            ...
            ObservableList<Part> tempParts = FXCollections.observableArrayList();
            tempParts = AddTable.getItems();        
            newProduct.setAssociatedParts(tempParts);        
